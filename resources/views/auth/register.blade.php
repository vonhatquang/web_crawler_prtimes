                                    ...
                                    <div class="position-relative my-4">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="name" type="text" name="name" required="required" autofocus="autofocus" class="form-control custom-border" aria-describedby="emailHelp">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input id="password" type="password" name="password" required="required" autocomplete="new-password" class="form-control custom-border">
                                            </div>

                                            <div class="mb-4">
                                                <label for="password_confirmation" class="form-label">確認パスワード</label>
                                                <input id="password_confirmation" type="password" name="password_confirmation" required="required" autocomplete="new-password" class="form-control custom-border">
                                            </div>  
                                            ...
                                            <button type="submit" class="btn btn-primary w-100 py-8 mb-4 rounded-2">登録</button>
                                        </form>
